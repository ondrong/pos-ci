...
REPLACE INTO `inv_penjualan` (`ID`, `ID_Jenis`, `Tanggal`, `Bulan`, `Tahun`, `NoUrut`, `Nomor`, `ID_Anggota`, `Deskripsi`, `Cicilan`, `Total`, `Tgl_Cicilan`, `ID_Post`, `ID_Close`) VALUES
	...
	(29, 1, '2012-10-29', 10, 2012, '4000000028', '00028-2012', 0, NULL, 0, 0, NULL, NULL, NULL),
	(30, 1, '2012-10-29', 10, 2012, '4000000029', '00029-2012', 7, '', 0, 21000000, '0000-00-00', '0', NULL),
...
CREATE TABLE IF NOT EXISTS `mst_anggota` (
  ...
  KEY `ID` (`ID`)
) ENGINE=MyISAM AUTO_INCREMENT=8 DEFAULT CHARSET=latin1 COMMENT='table anggota koperasi';
...
REPLACE INTO `mst_anggota` (`ID`, `ID_Jenis`, `NoUrut`, `ID_Aktif`, `ID_Dept`, `No_Perkiraan`, `NIP`, `No_Agt`, `Nama`, `ID_Check`, `ID_Kelamin`, `TanggalMasuk`, `TanggalKeluar`, `PhotoLink`, `Catatan`, `Alamat`, `Kota`, `Propinsi`, `Telepon`, `Faksimili`, `Status`) VALUES
	...
	(6, 2, 6, 1, NULL, NULL, NULL, '0006', 'SURYA BAJA GEMILANG', NULL, NULL, '2012-10-29 15:02:21', NULL, NULL, NULL, '', 'JAKARTA', '', '0217414833', '', '0'),
	(7, 1, 7, 0, 1, NULL, NULL, '0007', 'ADING', NULL, NULL, '2012-10-29 15:05:51', '2012-10-29', NULL, 'CV EKA JAYA', 'PARCOM', 'PURWAKARTA', '', '', '', '10000000');
...
REPLACE INTO `nomor_transaksi` (`nomor`, `jenis_transaksi`, `created_by`, `doc_date`) VALUES
	...
	('4000000028', 'GI', NULL, '2012-10-29 15:00:37'),
	('5000000002', 'GR', NULL, '2012-10-29 15:03:15'),
	('4000000029', 'GI', NULL, '2012-10-29 15:06:15'),
	('2000000007', 'D', NULL, '2012-10-29 15:19:38'),
	('2000000008', 'D', NULL, '2012-10-29 15:20:01'),
	('4000000030', 'GI', NULL, '2012-10-29 15:24:26'),
	('5000000003', 'GR', NULL, '2012-10-29 15:26:02'),
...
REPLACE INTO `perkiraan` (`ID`, `ID_Klas`, `ID_SubKlas`, `ID_Dept`, `ID_Unit`, `ID_Laporan`, `ID_LapDetail`, `ID_Agt`, `ID_Calc`, `ID_Simpanan`, `NoUrut`, `Kode`, `Perkiraan`, `SaldoAwal`) VALUES
	...
	(29, 4, 17, NULL, 1, 2, 30, 6, 2, 1, 0, NULL, NULL, 0),
	(30, 4, 18, NULL, 1, 2, 31, 6, 2, 2, 0, NULL, NULL, 0),
	(31, 4, 19, NULL, 1, 2, 32, 6, 2, 3, 0, NULL, NULL, 0),
	(32, 4, 4, NULL, 1, 2, 10, 6, 2, 4, 0, NULL, NULL, 0),
	(33, 4, 28, NULL, 1, 2, 9, 6, 1, 5, 0, NULL, NULL, 0),
	(34, 1, 5, 0, 1, 1, 1, 6, 1, 6, NULL, NULL, NULL, NULL),
	(35, 4, 17, 1, 1, 2, 30, 7, 2, 1, 0, NULL, NULL, 0),
	(36, 4, 18, 1, 1, 2, 31, 7, 2, 2, 0, NULL, NULL, 0),
	(37, 4, 19, 1, 1, 2, 32, 7, 2, 3, 0, NULL, NULL, 0),
	(38, 4, 4, 1, 1, 2, 10, 7, 2, 4, 0, NULL, NULL, 0),
	(39, 4, 28, 1, 1, 2, 9, 7, 1, 5, 0, NULL, NULL, 0);
...
REPLACE INTO `pinjaman_limit` (`ID_Agt`, `Tahun`, `max_limit`, `doc_date`, `created_by`) VALUES
	...
	(6, 2012, 0, '2012-10-29 15:02:21', NULL),
	(7, 2012, 10000000, '2012-10-29 15:05:10', NULL);
...
REPLACE INTO `transaksi_log` (`ID`, `ID_Trans`, `Keterangan`, `old_val`, `new_val`, `tanggal`, `created_by`) VALUES
	...
	(36, '34', 'Delete Pembelian  no. Faktur: 12', '20000', '0', '2012-10-29 15:56:44', '22674041831686144');
...
REPLACE INTO `transaksi_temp` (`ID`, `ID_Unit`, `ID_Dept`, `ID_Klas`, `ID_SubKlas`, `ID_CC`, `ID_Perkiraan`, `Debet`, `Kredit`, `Keterangan`, `ID_Bulan`, `Tahun`, `Tanggal`, `created_by`, `ID_Stat`) VALUES
	...
	(35, 1, 0, 1, 5, 4, 34, 31300, 0, 'Pembelian  no. Faktur: 1', '10', '2012', '2012-10-29', 'superuser', 0),
	(36, 1, 0, 4, 17, 1, 35, 0, 21000000, 'Penjualan Tunai no. Faktur: 00029-2012', '10', '2012', '2012-10-29', 'superuser', 0),
	(37, 1, 1, 6, 24, 5, 25, 1000, 0, 'Infaq', '10', '2012', '2012-10-29', 'superuser', 0),

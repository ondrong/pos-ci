...
-- Dumping data for table setujudb.inv_pembayaran: 23 rows
...
-- Dumping data for table setujudb.inv_penjualan: 28 rows
...
-- Dumping data for table setujudb.inv_penjualan_detail: 47 rows
...
-- Dumping data for table setujudb.inv_penjualan_rekap: 76 rows
...
-- Dumping data for table setujudb.mst_kas_trans: ~7 rows (approximately)
...
-- Dumping data for table setujudb.nomor_transaksi: 37 rows
...
-- Dumping data for table setujudb.transaksi_temp: 29 rows
